@php $user = auth('member')->user(); @endphp
        ...
        <div class="min-h-screen bg-gray-100">
            <nav x-data="{ open: false }" class="bg-white shadow-md">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-nav-link :href="route('member.invoices.index')" :active="request()->routeIs('member.invoices.*')">
                                    Invoices
                                </x-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    ...
                    <x-responsive-nav-link :href="route('member.invoices.index')" :active="request()->routeIs('member.invoices.*')">
                        Invoices
                    </x-responsive-nav-link>
                    ...
                    <div class="pt-2 border-t border-gray-200">
                        <div class="px-4">
                            <div class="font-medium text-base text-gray-800">{{ $user['firstname'] }}</div>
