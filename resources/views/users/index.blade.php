<x-app-layout>
                                    ...
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                            <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                                   ...
                                                   v-on:change="e => selectItem(user, e.target.checked)">
                                            <label :for="'user-' + user.id" class="sr-only">Select</label>
                                        </div>
                                    </td>
                                    <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                        <a class="text-base font-medium text-blue underline dark:text-blue-500 hover:no-underline hover:text-gray"
                                           :href="'{{ route('users.index') }}/' + user.id + '/edit'"
                                           v-text="user.name"></a>
                                    </th>
    ...
    <form name="deleteForm" action="{{ route('users.destroy') }}" method="POST">
        @csrf
        @method('DELETE')
        <input type="hidden" name="users" v-model="selectedItems">
    </form>
